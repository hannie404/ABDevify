...
const Training = () => {
    ...
    return (
        <section className="relative bg-[url('src/assets/images/home/training.png')] bg-cover bg-no-repeat px-6 py-16 before:absolute before:bottom-0 before:left-0 before:right-0 before:top-0 before:h-full before:w-full before:bg-primary-950/95 before:content-[''] lg:p-16">
